...
def _new_get_sampling_options():
    ...
    from external import spatial_sampling
    ...
    SAMPLING = [
        ...
        ("spatial", spatial_sampling.SpatialSampling)
    ]
...
def _new_get_crossover_options():
        ...
        from external import spatial_crossover
        CROSSOVER = [
            ...
            ("spatial_one_point_crossover", spatial_crossover.SpatialOnePointCrossover)
        ]
        return CROSSOVER
...
def _new_get_mutation_options():
    ...
    from external import spatial_mutation
    ...
    MUTATION = [
        ...
        ("spatial_n_point_mutation", spatial_mutation.SpatialNPointMutation, dict(point_mutation_probability = 0.01))
    ]
