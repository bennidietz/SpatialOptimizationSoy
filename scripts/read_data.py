...
if os.path.isfile(settings.get_file_landuse()):
    if not allClassifiedRastersExist():
        ...
        amazon_crop = landuse_reclass[1300:1400, 2750:2850] # 100 x 100
        ...
        cerrado_crop = landuse_reclass[3700:3800, 4000:4100] # 100 x 100
...
if os.path.exists(settings.get_file_soy()):
    if os.path.exists(settings.get_file_soy_amazon()):
        ...
        soy_pot_yield_amazon = np.loadtxt(settings.get_file_soy(), skiprows=6)[1300:1400, 2750:2850] # 400 x 400
    ...
    if os.path.exists(settings.get_file_soy_cerrado()):
        ...
        soy_pot_yield_cerrado = np.loadtxt(settings.get_file_soy(),skiprows=6)[3700:3800, 4000:4100] # 400 x 400
